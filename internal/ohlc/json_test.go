...
func TestParseFileETH(t *testing.T) {
	expected := []OHLC{
		{1658503800000, decimal.NewFromFloat(1604.49), decimal.NewFromFloat(1604.49), decimal.NewFromFloat(1588.17), decimal.NewFromFloat(1588.17)},
		{1658505600000, decimal.NewFromFloat(1580.76), decimal.NewFromFloat(1580.76), decimal.NewFromFloat(1575.37), decimal.NewFromFloat(1576.38)},
		{1658507400000, decimal.NewFromFloat(1575.56), decimal.NewFromFloat(1575.76), decimal.NewFromFloat(1566.92), decimal.NewFromFloat(1575.76)},
		{1658509200000, decimal.NewFromFloat(1577.02), decimal.NewFromFloat(1580.27), decimal.NewFromFloat(1577.02), decimal.NewFromFloat(1580.27)},
		{1658511000000, decimal.NewFromFloat(1581.09), decimal.NewFromFloat(1586.54), decimal.NewFromFloat(1578.77), decimal.NewFromFloat(1578.77)},
		{1658512800000, decimal.NewFromFloat(1575.91), decimal.NewFromFloat(1577.23), decimal.NewFromFloat(1564.48), decimal.NewFromFloat(1564.48)},
		{1658514600000, decimal.NewFromFloat(1568.44), decimal.NewFromFloat(1568.44), decimal.NewFromFloat(1563.11), decimal.NewFromFloat(1564.81)},
		{1658516400000, decimal.NewFromFloat(1567.17), decimal.NewFromFloat(1574.23), decimal.NewFromFloat(1567.17), decimal.NewFromFloat(1574.23)},
		{1658518200000, decimal.NewFromFloat(1576.02), decimal.NewFromFloat(1580.64), decimal.NewFromFloat(1574.5), decimal.NewFromFloat(1580.64)},
		{1658520000000, decimal.NewFromFloat(1579.14), decimal.NewFromFloat(1579.14), decimal.NewFromFloat(1532.15), decimal.NewFromFloat(1532.15)},
		{1658521800000, decimal.NewFromFloat(1530.48), decimal.NewFromFloat(1531.76), decimal.New(15280, -1), decimal.NewFromFloat(1531.76)},
		{1658523600000, decimal.NewFromFloat(1531.17), decimal.NewFromFloat(1534.62), decimal.NewFromFloat(1528.18), decimal.NewFromFloat(1528.18)},
		{1658525400000, decimal.NewFromFloat(1526.75), decimal.NewFromFloat(1538.57), decimal.NewFromFloat(1526.75), decimal.NewFromFloat(1538.57)},
		{1658527200000, decimal.NewFromFloat(1537.18), decimal.NewFromFloat(1541.49), decimal.NewFromFloat(1537.18), decimal.NewFromFloat(1541.49)},
		{1658529000000, decimal.NewFromFloat(1540.72), decimal.NewFromFloat(1540.72), decimal.NewFromFloat(1537.44), decimal.NewFromFloat(1537.44)},
		{1658530800000, decimal.NewFromFloat(1533.29), decimal.NewFromFloat(1542.11), decimal.NewFromFloat(1533.29), decimal.NewFromFloat(1542.11)},
		{1658532600000, decimal.NewFromFloat(1541.05), decimal.NewFromFloat(1542.1), decimal.NewFromFloat(1538.17), decimal.NewFromFloat(1541.35)},
		{1658534400000, decimal.NewFromFloat(1540.76), decimal.NewFromFloat(1540.76), decimal.NewFromFloat(1535.34), decimal.NewFromFloat(1536.12)},
		{1658536200000, decimal.NewFromFloat(1537.65), decimal.NewFromFloat(1538.08), decimal.NewFromFloat(1532.04), decimal.NewFromFloat(1538.08)},
		{1658538000000, decimal.NewFromFloat(1546.91), decimal.NewFromFloat(1547.09), decimal.NewFromFloat(1544.03), decimal.NewFromFloat(1545.23)},
		{1658539800000, decimal.NewFromFloat(1545.6), decimal.NewFromFloat(1548.03), decimal.NewFromFloat(1544.63), decimal.NewFromFloat(1547.27)},
		{1658541600000, decimal.NewFromFloat(1549.89), decimal.NewFromFloat(1553.61), decimal.NewFromFloat(1549.61), decimal.NewFromFloat(1553.61)},
		{1658543400000, decimal.NewFromFloat(1553.04), decimal.NewFromFloat(1561.84), decimal.NewFromFloat(1553.04), decimal.NewFromFloat(1561.84)},
		{1658545200000, decimal.NewFromFloat(1564.6), decimal.NewFromFloat(1573.54), decimal.NewFromFloat(1564.6), decimal.NewFromFloat(1569.81)},
		{1658547000000, decimal.NewFromFloat(1569.1), decimal.NewFromFloat(1570.97), decimal.NewFromFloat(1565.43), decimal.NewFromFloat(1570.97)},
		{1658548800000, decimal.NewFromFloat(1571.71), decimal.NewFromFloat(1577.24), decimal.NewFromFloat(1571.71), decimal.NewFromFloat(1575.13)},
		{1658550600000, decimal.NewFromFloat(1574.25), decimal.NewFromFloat(1575.45), decimal.NewFromFloat(1568.79), decimal.NewFromFloat(1568.79)},
		{1658552400000, decimal.NewFromFloat(1571.61), decimal.NewFromFloat(1586.54), decimal.NewFromFloat(1571.61), decimal.NewFromFloat(1586.54)},
		{1658554200000, decimal.NewFromFloat(1591.37), decimal.NewFromFloat(1591.93), decimal.NewFromFloat(1588.75), decimal.NewFromFloat(1589.91)},
		{1658556000000, decimal.NewFromFloat(1588.33), decimal.NewFromFloat(1588.33), decimal.NewFromFloat(1581.69), decimal.NewFromFloat(1584.05)},
		{1658557800000, decimal.NewFromFloat(1582.26), decimal.NewFromFloat(1582.86), decimal.NewFromFloat(1581.04), decimal.NewFromFloat(1581.04)},
		{1658559600000, decimal.NewFromFloat(1581.4), decimal.NewFromFloat(1588.48), decimal.NewFromFloat(1581.4), decimal.NewFromFloat(1586.19)},
		{1658561400000, decimal.NewFromFloat(1583.46), decimal.NewFromFloat(1583.46), decimal.NewFromFloat(1576.88), decimal.NewFromFloat(1583.23)},
		{1658563200000, decimal.NewFromFloat(1582.94), decimal.NewFromFloat(1582.94), decimal.NewFromFloat(1575.13), decimal.NewFromFloat(1575.13)},
		{1658565000000, decimal.NewFromFloat(1579.49), decimal.NewFromFloat(1584.7), decimal.NewFromFloat(1579.49), decimal.NewFromFloat(1581.67)},
		{1658566800000, decimal.NewFromFloat(1586.3), decimal.NewFromFloat(1586.3), decimal.NewFromFloat(1562.45), decimal.NewFromFloat(1562.45)},
		{1658568600000, decimal.NewFromFloat(1557.26), decimal.NewFromFloat(1559.37), decimal.NewFromFloat(1555.72), decimal.NewFromFloat(1556.57)},
		{1658570400000, decimal.NewFromFloat(1561.04), decimal.NewFromFloat(1566.01), decimal.NewFromFloat(1559.52), decimal.NewFromFloat(1559.52)},
		{1658572200000, decimal.NewFromFloat(1559.74), decimal.NewFromFloat(1563.92), decimal.NewFromFloat(1558.27), decimal.NewFromFloat(1560.49)},
		{1658574000000, decimal.NewFromFloat(1556.97), decimal.NewFromFloat(1556.97), decimal.NewFromFloat(1544.08), decimal.NewFromFloat(1544.08)},
		{1658575800000, decimal.NewFromFloat(1541.76), decimal.NewFromFloat(1541.76), decimal.NewFromFloat(1533.03), decimal.NewFromFloat(1537.85)},
		{1658577600000, decimal.NewFromFloat(1539.63), decimal.NewFromFloat(1539.63), decimal.NewFromFloat(1523.69), decimal.NewFromFloat(1523.69)},
		{1658579400000, decimal.NewFromFloat(1524.69), decimal.NewFromFloat(1524.69), decimal.NewFromFloat(1516.99), decimal.NewFromFloat(1524.05)},
		{1658581200000, decimal.NewFromFloat(1522.79), decimal.NewFromFloat(1524.44), decimal.NewFromFloat(1521.92), decimal.NewFromFloat(1521.92)},
		{1658583000000, decimal.NewFromFloat(1521.52), decimal.NewFromFloat(1526.18), decimal.NewFromFloat(1521.52), decimal.NewFromFloat(1526.18)},
		{1658584800000, decimal.NewFromFloat(1523.86), decimal.NewFromFloat(1533.35), decimal.NewFromFloat(1523.86), decimal.NewFromFloat(1533.35)},
		{1658586600000, decimal.NewFromFloat(1532.4), decimal.NewFromFloat(1535.02), decimal.NewFromFloat(1531.7), decimal.NewFromFloat(1531.7)},
		{1658588400000, decimal.New(15290, -1), decimal.NewFromFloat(1530.14), decimal.NewFromFloat(1522.44), decimal.NewFromFloat(1522.44)},
		{1658590200000, decimal.NewFromFloat(1530.99), decimal.NewFromFloat(1530.99), decimal.NewFromFloat(1530.36), decimal.NewFromFloat(1530.95)},
	}
